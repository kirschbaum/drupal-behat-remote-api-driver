...
interface HttpClientInterface
{
     ...
     * @param null|string $requestCookie Optionally add a cookie to the request
     *
     * @return  If no authentication method was given
     */
    public function authenticate($tokenOrLogin, $password, $authMethod, $requestCookie);
}
